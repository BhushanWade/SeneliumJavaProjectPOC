...
public class ResultsPage {
	...
	private By searchProucts = By.cssSelector("div.product-layout");
	...
	public int getSearchProductCount() {
		int productCount =  eleUtil.waitForElementsVisible(searchProucts, TimeUtil.DEFAULT_TIME_OUT).size();
		System.out.println("Product Search Count : " + productCount);
		return productCount;
	}
	
	public ProductInfoPage selectProduct(String mainProductName) {
		System.out.println("Main Praduct name : "+mainProductName);
